...
async def inline_button_handler(callback_query: types.CallbackQuery):
    await callback_query.message.answer_photo(photo="https://plus.unsplash.com/premium_photo-1679826780076-5926172bd6bf?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8bG9jYXRpb24lMjBsb2dvfGVufDB8fDB8fHww", caption="You're current location🏙", reply_markup=git)
...
async def ca(callback: CallbackQuery):
    ...
    for x in List:
        await callback.message.answer_photo(f"{x}", caption="выберете 1 из 3?", reply_markup=location)
...
async def rest(callback: CallbackQuery):
    ...
    for x in sama:
        await callback.message.answer_photo(f"{x}", caption="Вам понравилось этот Ресторан", reply_markup=samarqand.as_markup())
...
async def hot(callback: CallbackQuery):
    ...
    for x in hot:
        await callback.message.answer_photo(f"{x}", caption="Вам понравилось этот Отель", reply_markup=samarqand.as_markup())
...
async def park(callback: CallbackQuery):
    ...
    for x in park:
        await callback.message.answer_photo(f"{x}", caption="Вам понравилось этот Парк", reply_markup=samarqand.as_markup())
...
async def sama(callback: CallbackQuery):
    f = [rasm13, rasm14, rasm15]
    for x in f:
        await callback.message.answer_photo(f"{x}", caption="Do you prefer Cafe?", reply_markup=engsama.as_markup())
...
async def rest(callback: CallbackQuery):
    sama = [rasm16, rasm17, rasm18]
    for x in sama:
        await callback.message.answer_photo(f"{x}", caption="Do you prefer Restaurant", reply_markup=engsama.as_markup())
...
async def hot(callback: CallbackQuery):
    hot = [rasm19, rasm20, rasm21]
    for x in hot:
        await callback.message.answer_photo(f"{x}", caption="Do you prefer Hotel", reply_markup=engsama.as_markup())
...
async def park(callback: CallbackQuery):
    park = [rasm22, rasm23, rasm24]
    for x in park:
        await callback.message.answer_photo(f"{x}", caption="Do you prefer Park", reply_markup=engsama.as_markup())
...
async def caf(callback: CallbackQuery):
    ...
    for x in xor:
        await callback.message.answer_photo(f"{x}", caption="Вам понравилось этот Кафе?", reply_markup=rusxor.as_markup())
...
async def caf(callback: CallbackQuery):
    ...
    for x in restt:
        await callback.message.answer_photo(f"{x}", caption="Вам понравилось этот Ресторанам?", reply_markup=rusxor.as_markup())
...
async def caf(callback: CallbackQuery):
    ...
    for x in hotell:
        await callback.message.answer_photo(f"{x}", caption="Вам понравилось этот Отель?", reply_markup=rusxor.as_markup())
...
async def caf(callback: CallbackQuery):
    xor = [rasm25, rasm26, rasm27]
    for x in xor:
        await callback.message.answer_photo(f"{x}", caption="Do you prefer Cafe?", reply_markup=engxor.as_markup())
...
async def caf(callback: CallbackQuery):
    restt = [rasm28, rasm29, rasm30]
    for x in restt:
        await callback.message.answer_photo(f"{x}", caption="Do you prefer Restaurant?", reply_markup=engxor.as_markup())
...
async def caf(callback: CallbackQuery):
    hotell = [rasm31, rasm32, rasm33]
    for x in hotell:
        await callback.message.answer_photo(f"{x}", caption="Do you prefer Hotel?", reply_markup=engxor.as_markup())
...
async def caf(callback: CallbackQuery):
    ...
    for x in bux:
        await callback.message.answer_photo(f"{x}", caption="Вам понравилось этот Кафе?", reply_markup=rusbuxor.as_markup())
...
async def caf(callback: CallbackQuery):
    ...
    for x in bux:
        await callback.message.answer_photo(f"{x}", caption="Вам понравилось этот Ресторанам?", reply_markup=rusbuxor.as_markup())
...
async def caf(callback: CallbackQuery):
    ...
    for x in bux:
        await callback.message.answer_photo(f"{x}", caption="Вам понравилось этот Отель?", reply_markup=rusbuxor.as_markup())
...
async def caf(callback: CallbackQuery):
    ...
    for x in bux:
        await callback.message.answer_photo(f"{x}", caption="Вам понравилось этот Парк?", reply_markup=rusbuxor.as_markup())
...
async def caf(callback: CallbackQuery):
    bux = [rasm34, rasm35, rasm36]
    for x in bux:
        await callback.message.answer_photo(f"{x}", caption="Do you prefer Cafe?", reply_markup=engbuxor.as_markup())
...
async def caf(callback: CallbackQuery):
    bux = [rasm37, rasm38, rasm39]
    for x in bux:
        await callback.message.answer_photo(f"{x}", caption="Do you prefer Restaurant?", reply_markup=engbuxor.as_markup())
...
async def caf(callback: CallbackQuery):
    bux = [rasm40, rasm41, rasm42]
    for x in bux:
        await callback.message.answer_photo(f"{x}", caption="Do you prefer Hotel?", reply_markup=engbuxor.as_markup())
...
async def caf(callback: CallbackQuery):
    bux = [rasm43, rasm44, rasm45]
    for x in bux:
        await callback.message.answer_photo(f"{x}", caption="Do you prefer Park?", reply_markup=engbuxor.as_markup())
...
async def tash(callback: CallbackQuery):
    ...
    for x in tash:
        await callback.message.answer_photo(f"{x}", caption="Вам понравилось этот Кафе", reply_markup=)
