...
async def tash(callback: CallbackQuery):
    tash = [rasm46, rasm47, rasm48]
    for x in tash:
        await callback.message.answer_photo(f"{x}", caption="Do you prefer this Cafe", reply_markup=tashkentengcafe.as_markup())
...
async def tash(callback: CallbackQuery):
    tash = [rasm49, rasm50, rasm51]
    for x in tash:
        await callback.message.answer_photo(f"{x}", caption="Do you prefer this Restaurant", reply_markup=tashkentengrestoran.as_markup())
...
async def tash(callback: CallbackQuery):
    tash = [rasm52, rasm53, rasm54]
    for x in tash:
        await callback.message.answer_photo(f"{x}", caption="Do you prefer this Hotel", reply_markup=tashkentenghotel.as_markup())
...
async def tash(callback: CallbackQuery):
    tash = [rasm55, rasm56, rasm57]
    for x in tash:
        await callback.message.answer_photo(f"{x}", caption="Do you prefer this Park", reply_markup=tashkentengpark.as_markup())
...
async def tash(callback: CallbackQuery):
    await callback.message.answer_photo(photo="https://lh5.googleusercontent.com/p/AF1QipN01Zx5PhsDqGBcVJV7_Ln4rc1lIpXtnmJs4AM9=w540-h312-n-k-no", reply_markup=uba9, caption="Добро пожаловать в Наманган"
                                                                                                                                                                                                                                                   "\nВыберете 1 из 4!")

@dp.callback_query(F.data == "jafe")
async def tash(callback: CallbackQuery):
    tash = [rasm58, rasm59, rasm60]
    for x in tash:
...
async def tash(callback: CallbackQuery):
    tash = [rasm67, rasm68, rasm69]
    for x in tash:
        await callback.message.answer_photo(f"{x}", caption="Вам понравилось этот Парк", reply_markup=namanganrushotel.as_markup())
...
async def tash(callback: CallbackQuery):
    await callback.message.answer_photo(photo="https://lh5.googleusercontent.com/p/AF1QipN01Zx5PhsDqGBcVJV7_Ln4rc1lIpXtnmJs4AM9=w540-h312-n-k-no", reply_markup=namanganeng, caption="Welcome to the Namangan"
                                                                                                                                                                                                                                                   "\nChoose what you need")
...
async def tash(callback: CallbackQuery):
    tash = [rasm58, rasm59, rasm60]
    for x in tash:
        await callback.message.answer_photo(f"{x}", caption="Do you prefer Cafe", reply_markup=namanganengcafe.as_markup())
...
async def tash(callback: CallbackQuery):
    tash = [rasm61, rasm62, rasm63]
    for x in tash:
        await callback.message.answer_photo(f"{x}", caption="Do you prefer this Restaurant", reply_markup=namanganengrestoran.as_markup())
...
async def tash(callback: CallbackQuery):
    tash = [rasm64, rasm65, rasm66]
    for x in tash:
        await callback.message.answer_photo(f"{x}", caption="Do you prefer this Hotel", reply_markup=namanganenghotel.as_markup())
...
async def tash(callback: CallbackQuery):
    tash = [rasm67, rasm68, rasm69]
    for x in tash:
        await callback.message.answer_photo(f"{x}", caption="Do you prefer this Park", reply_markup=namanganenghotel.as_markup())
